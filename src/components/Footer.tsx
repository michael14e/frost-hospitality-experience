      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200'>
          ...
          <div className='flex space-x-8 text-sm text-gray-600 mb-4 md:mb-0'>
            <div onClick={() => navigateWithScroll(navigate, '/')} className='hover:text-blue-500 cursor-pointer'>
              Home
            </div>
            <div onClick={() => navigateWithScroll(navigate, '/about')} className='hover:text-blue-500 cursor-pointer'>
              About
            </div>
            <div onClick={() => navigateWithScroll(navigate, '/experiences')} className='hover:text-blue-500 cursor-pointer'>
              Experience
            </div>
            <div onClick={() => navigateWithScroll(navigate, '/contact')} className='hover:text-blue-500 cursor-pointer'>
              Contact
            </div>
          </div>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center mt-8 pt-8 border-t border-gray-200 text-sm text-gray-500'>
          ...
          {/* <div className='flex space-x-6 mt-4 md:mt-0'>
            ...
            <div onClick={() => navigateWithScroll(navigate, '/privacy')} className='hover:text-blue-500 cursor-pointer'>
              Privacy
            </div>
