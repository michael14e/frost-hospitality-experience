...
const Footer = () => {
  return <footer className="pb-8 relative overflow-hidden bg-slate-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-lg p-8 mb-16">
          <div className="max-w-md">
            ...
            <div className="flex">
              <input type="email" placeholder="Enter your email" className="flex-1 px-4 py-2 border border-gray-300 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" />
