const OurVision = () => {
  const visionPoints = ["Simplify Process", "Improve Services", "Give Opportunities", "Showcase Offerings", "Social Responsibility"];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4">
              {visionPoints.map((point, index) => <div key={index} className="flex items-center space-x-4 bg-white/80 backdrop-blur-sm rounded-lg p-4">
          ...
          <div className="flex justify-center">
            <img src="/lovable-uploads/b522a3d6-038d-418f-b2e5-bf7535736e13.png" alt="Business collage" className="w-full max-w-md h-auto object-cover rounded-lg" />
          </div>
        </div>
      </div>
    </section>;
